...
public class ScenarioRun1simBerlin {
	...
	public void cleanUpFolders() throws IOException {
		...
		ScenarioRun1simBerlin deletefiles = new ScenarioRun1simBerlin();
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					Server.main(new String[] {"-conf", "conf/1SimConfigBerlin.json", "--monitor"});				
