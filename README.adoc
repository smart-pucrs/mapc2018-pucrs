...
This is the source code of the {smart-team} team, one of the teams participating in the https://multiagentcontest.org/2018/[2018 Multi-Agent Programming Contest (MAPC) in 2018]. 
